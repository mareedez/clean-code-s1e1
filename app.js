...
var createNewTaskElement=function(taskString){
    ...
    editInput.type="text";
    editInput.className="tasks__input-edit";
...
var taskCompleted=function(){
    ...
    var listItem=this.parentNode;
    listItem.children[1].classList.add("completed-tasks__label");
...
//Mark task as incomplete.
    ...
    var listItem=this.parentNode;
    listItem.children[1].classList.remove("completed-tasks__label");
    listItem.children[1].classList.add("incomplete-tasks__label");
    listItem.children[0].checked = false;
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem,taskCompleted);
}
...
//select ListItems children
    ...
    var editButton=taskListItem.querySelector("button.tasks__button-edit");
    var deleteButton=taskListItem.querySelector("button.tasks__button-delete");
